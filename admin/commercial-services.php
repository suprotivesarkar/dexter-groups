...
<div class="col-xl-12">
<div class="card card-statistics h-100">
<div class="card-title"><h5>Commercial Service List<a href="" data-toggle="modal" data-target="#addMod" class="button x-small pull-right">ADD NEW <i class="fa fa-plus"></i></a></h5></div>
<div class="card-body">
...
<div class="modal-title"><h4>Add New Commercial Service</h4></div>
...
<label for="proname">Enter Commercial Service Name:<span class="req">*</span></label>
...
function fetchPro(){
  $.ajax({
    type: "POST",
    url: "helper/master/commercial_service",
