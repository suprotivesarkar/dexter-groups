...
<h5>project List <a href="" data-toggle="modal" data-target="#addMod" class="button x-small pull-right"><i class="fa fa-plus"></i> Add New</a></h5>
</div>
<div class="card-body">
...
<div class="modal-title"><h4>Add New Project</h4></div>
...
<div class="form-group col-sm-6">
<label for="img">Select Project Image:[800X425]</label>
<input type="file" class="form-control" id="img" name="image">
</div>
<div class="form-group col-sm-12">
<label for="msg">Small-Description:</label>
...
<div class="modal-content">
<div class="modal-header">
<div class="modal-title"><h4>Update Project</h4></div>
<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
</div>
<div class="modal-body">
...
<div class="row">
<div class="form-group col-sm-6">
<label for="upname">Enter Project Name:</label>
<input type="text" class="form-control" id="upname" name="upname" required="" autofocus="">
</div>
<div class="form-group col-sm-6">
<label for="upimg">Select Project Image:[800X425]</label>
<input type="file" class="form-control" id="upimg" name="image">
</div>
<div class="form-group col-sm-12">
<label for="upmsg">Small-Description:</label>
<textarea class="form-control" rows="2" id="upmsg" name="upmsg" required=""></textarea>
</div>
<div class="form-group col-12">
...
function fetchData(){$.post("helper/master/project",{"operation":"fetch"},function(data){$(".loadpan").html(data);$('#entry_table').DataTable({stateSave:true});});}
</script>
</body>
</html>