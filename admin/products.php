...
<div class="col-xl-12">
<div class="card card-statistics h-100">
<div class="card-title"><h5>Product Type<a href="" data-toggle="modal" data-target="#addMod" class="button x-small pull-right">ADD NEW <i class="fa fa-plus"></i></a></h5></div>
<div class="card-body">
...
<div class="modal-title"><h4>Add New Product</h4></div>
...
<label for="proname">Enter Product Name:<span class="req">*</span></label>
