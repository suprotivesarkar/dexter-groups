...
<html lang="en">
<head> 
<title>Technical Services Update</title>
...
<h5>Update Technical Service - <?= $data->tech_name; ?> <a href="technical-services" class="button x-small pull-right"><i class="fa fa-long-arrow-left"></i> Back</a></h5>
</div> 
<div class="card-body">
<form id="addfrm" autocomplete="off" enctype="multipart/form-data">
<div class="row">
<div class="form-group col-sm-6">
<label for="roomname">Enter Technical Service Name:</label>
<input type="text" class="form-control" id="roomname" name="roomname" required="" autofocus="" value="<?php echo $data->tech_name; ?>">
</div>
<div class="form-group col-sm-6">
<label for="roomname">Enter Technical Service Url:</label>
<input type="text" class="form-control" id="roomurl" name="roomurl" required="" value="<?php echo $data->tech_slug; ?>">
</div>

<!-- <div class="form-group col-sm-4">
<label for="roomimg">Technical Service Image:[400X485]</label>
<input type="file" class="form-control" id="roomimg" name="timage">
</div> -->
<div class="form-group col-sm-4">
<label for="coverimg">Technical Service Banner Image:[1350X250]</label>
<input type="file" class="form-control" id="coverimg" name="image">
</div>

<div class="form-group col-sm-12">
<label for="smalldesc">Technical Service Small-Description</label>
<textarea class="form-control" id="smalldesc" name="smalldesc" rows="3"><?php echo $data->tech_small_desc; ?></textarea>
</div>
<!-- <div class="form-group col-sm-12">
<label for="fulldesc">Technical Service Full-Description</label>
<textarea class="form-control" id="fulldesc" name="fulldesc" rows="3"><?php echo $data->tech_full_desc; ?></textarea>
</div> -->
