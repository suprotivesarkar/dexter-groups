...
<h5>About List <a href="" data-toggle="modal" data-target="#addMod" class="button x-small pull-right"><i class="fa fa-plus"></i> Add New</a></h5>
</div>
<div class="card-body">
...
<div class="modal-title"><h4>Add New Div</h4></div>
...
<label for="name">Enter Heading:</label>
<input type="text" class="form-control" id="name" name="name" required="" autofocus="">
</div>
<div class="form-group col-sm-6">
<label for="img">Select Icon:</label>
...
<div class="modal-content">
<div class="modal-header">
<div class="modal-title"><h4>Update Div</h4></div>
<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
</div>
<div class="modal-body">
...
e.preventDefault();
if($("#addfrm").valid()){
    var url="helper/master/about_us";
...
function fetchData(){$.post("helper/master/about_us",{"operation":"fetch"},function(data){$(".loadpan").html(data);$('#entry_table').DataTable({stateSave:true});});}
</script>
</body>
</html>