...
<html lang="en">
<head> 
<title>Commercial Service Update</title>
...
<h5>Update commercial Service - <?= $data->com_name; ?> <a href="commercial-services" class="button x-small pull-right"><i class="fa fa-long-arrow-left"></i> Back</a></h5>
</div> 
<div class="card-body">
<form id="addfrm" autocomplete="off" enctype="multipart/form-data">
<div class="row">
<div class="form-group col-sm-6">
<label for="roomname">Enter Commercial Service Name:</label>
<input type="text" class="form-control" id="roomname" name="roomname" required="" autofocus="" value="<?php echo $data->com_name; ?>">
</div>
<div class="form-group col-sm-6">
<label for="roomname">Enter Commercial Service Url:</label>
<input type="text" class="form-control" id="roomurl" name="roomurl" required="" value="<?php echo $data->com_slug; ?>">
</div>

<!-- <div class="form-group col-sm-4">
<label for="roomimg">Commercial Service Image:[400X485]</label>
<input type="file" class="form-control" id="roomimg" name="timage">
</div> -->
<div class="form-group col-sm-4">
<label for="coverimg">Commercial Service Banner Image:[1350X250]</label>
<input type="file" class="form-control" id="coverimg" name="image">
</div>

<div class="form-group col-sm-12">
<label for="smalldesc">Commercial Service Small-Description</label>
<textarea class="form-control" id="smalldesc" name="smalldesc" rows="3"><?php echo $data->com_small_desc; ?></textarea>
</div>
<!-- <div class="form-group col-sm-12">
<label for="fulldesc">Commercial Service Full-Description</label>
<textarea class="form-control" id="fulldesc" name="fulldesc" rows="3"><?php echo $data->com_full_desc; ?></textarea>
</div> -->
...
e.preventDefault();
if($("#addfrm").valid()){
    var url="helper/master/commercial_service";
