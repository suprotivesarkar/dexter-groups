...
<h5>Technical Service Type - <?= $data->tech_name; ?> <a href="products" class="button x-small pull-right"><i class="fa fa-long-arrow-left"></i> Back</a> <a href="technical_update?id=<?php echo $id; ?>" class="button x-small pull-right mx-2"><i class="fa fa-pencil"></i> Update</a></h5></div>
<div class="card-body">
<ul class="nav nav-tabs thmnavtab">
<li class="nav-item"><a class="nav-link" href="technical-brief?id=<?= $data->tech_id; ?>">Brief Info</a></li>
<li class="nav-item"><a class="nav-link active" href="technical-gallery?id=<?= $data->tech_id; ?>">Technical Services</a></li>
</ul>
<div class="row">
<div class="col-xl-12">
<div class="card card-statistics h-100">
<div class="card-title"><h5>Technical Services<a href="" data-toggle="modal" data-target="#addThumb" class="button x-small pull-right"><i class="fa fa-plus"></i> ADD SERVICE</a></h5></div>
<div class="card-body">
...
e.preventDefault();
if($("#thumbAdd").valid()){
    var url="helper/master/tech-gallery";
    var data = new FormData(this);
    data.append("operation","addGal");
    data.append("id","<?= $data->tech_id; ?>");
    $.ajax({
...
function fetchCover(){
  $.ajax({
    type: "POST",
    url: "helper/master/tech-gallery",
    data: {"acmrid":<?php echo $data->tech_id; ?>,"operation":"fetchGal"},
    beforeSend: function(){},
