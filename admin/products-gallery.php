...
<li class="nav-item"><a class="nav-link" href="product-brief?id=<?= $data->pro_id; ?>">Brief Info</a></li>
<li class="nav-item"><a class="nav-link active" href="products-gallery?id=<?= $data->pro_id; ?>">Products</a></li>
</ul>
<div class="row">
<div class="col-xl-12">
<div class="card card-statistics h-100">
<div class="card-title"><h5>Products<a href="" data-toggle="modal" data-target="#addThumb" class="button x-small pull-right"><i class="fa fa-plus"></i> ADD PRODUCT</a></h5></div>
<div class="card-body">
...
<div class="modal-title"><h4>Add Products</h4></div>
...
<div class="form-group col-sm-12">
<label for="thumbimgname">Product Name Name:</label>
...
<div class="modal-content">
<div class="modal-header">
<div class="modal-title"><h4>Update Products</h4></div>
<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
</div>
<div class="modal-body">
...
<div class="form-group col-sm-12">
<label for="upthumbimgname">Product Name:</label>
...
e.preventDefault();
if($("#thumbAdd").valid()){
    var url="helper/master/product-gallery";
    var data = new FormData(this);
    data.append("operation","addGal");
    data.append("id","<?= $data->pro_id; ?>");
    $.ajax({
...
function fetchCover(){
  $.ajax({
    type: "POST",
    url: "helper/master/product-gallery",
    data: {"acmrid":<?php echo $data->pro_id; ?>,"operation":"fetchGal"},
    beforeSend: function(){},
